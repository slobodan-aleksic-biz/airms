...
export class FlightRoutesService {
  ...
  private get url() {
    return this.getUserRole() + '/flight-routes';
  }

  private serverUrl: string = 'flight-evidence/log-book/flight-routes';
  ...
  update(id, item: FlightRoute): void {
  ...
  feedAirportsDropDown(): Promise<Array<[]>> {
    let url = '/api/' + this.getUserRole() + '/airports';
