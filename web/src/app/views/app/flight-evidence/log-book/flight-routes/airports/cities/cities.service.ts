...
export class CitiesService {
  ...
  private get url() {
    return this.getUserRole() + '/cities';
  }

  private serverUrl: string = 'flight-evidence/log-book/flight-routes/airports/cities';
