...
export class AircraftsService {
  ...
  feedAircraftTypesDropDown(): Promise<Array<[]>> {
    let url = '/api/' + this.getUserRole() + '/aircraft-types';
    return this.feedFunc('get', url);
  }

  feedAircraftsDropDown(aircraftTypeId: number): Promise<Array<[]>> {
    let url = '/api/' + this.getUserRole() + '/aircrafts';
    return this.feedFunc('get', url, null, { params : { 'aircraft_type_id': aircraftTypeId }});
  }
