...
export class AircraftPartsMainFormComponent implements OnInit, OnDestroy {
  ...
  private breadcrumbMenu() {
    this.breadcrumbMenuService.settingsItems.next([
      {
        name: 'ATA Chapters',
        path: './stock/aircraft-parts/ata-chapters/datatable',
      ...
      {
        name: 'Aircrafts',
        path: './stock/aircraft-parts/aircrafts',
        icon: 'icon-plane',
      },
      {
        name: 'Owners',
        path: './stock/aircraft-parts/owners',
        icon: 'icon-plane',
      },
      {
        name: '--',
      ...
      {
        name: 'Stocks',
        path: './stock/aircraft-parts/stocks',
        icon: 'icon-plane',
      },
      {
        name: 'Quantity Units',
        path: './stock/aircraft-parts/quantity-units',
        icon: 'icon-plane',
      },
      {
        name: '--',
      ...
      {
        name: 'Shops',
        path: './stock/aircraft-parts/shops',
        icon: 'icon-plane',
      },
    ]);
  }
